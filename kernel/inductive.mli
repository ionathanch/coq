...
val constrained_type_of_inductive : env -> mind_specif puniverses -> types Univ.constrained
val constrained_type_of_inductive_knowing_parameters :
  env -> mind_specif puniverses -> types Lazy.t array -> types Univ.constrained
